        ...
        <div className="p-5">
            <div className="row d-flex align-items-center">
                <div className="col-lg-5 mx-auto text-start order-2 order-lg-1">
                    <h3 style={{color: 'white'}}>Choose From Close to a Million Used Cars</h3>
                    <p style={{color: 'white'}}>Get access to our extensive selection of pre-owned vehicles for sale across the US, and see price ratings based on similar used car listings in your area, so you know when you’re getting a great deal.</p>
