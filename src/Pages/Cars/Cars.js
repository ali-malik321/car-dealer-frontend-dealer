...
const Cars = () => {
    ...
    useEffect(() => {
        ...
        fetch(`${BASE_URL}cars?condition=${carCondition}`)
            .then(res => res.json())
            .then(cars => {
                setCars(cars);
                                ...
                                <div className="list-group my-3">
                                    <div className="my-3">
                                        <div className="d-flex">
                                            <h6 style={{color: 'white'}} className="ms-2">Brands</h6>
                                        </div>
                                    ...
                                    <div className="my-3">
                                        <div className="d-flex">
                                            <h6 style={{color: 'white'}} className="ms-2">Models</h6>
                                        </div>
                                    ...
                                    <div className="my-3">
                                        <div className="d-flex">
                                            <h6 style={{color: 'white'}} className="ms-2">Types</h6>
                                        </div>
